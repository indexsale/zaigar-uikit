...
var Icon$v2 = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 90 90" }, props),
        React__default['default'].createElement("image", { width: 90, height: 90, href: "/images/zai/92.png" })));
};
...
var SpinnerIcon = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 96 96" }, props),
        React__default['default'].createElement("image", { width: "96", height: "96", href: "/images/zai/92.png" })));
};
...
var Icon$17 = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 24 15" }, props),
...
var MenuLink = function (_a) {
    ...
    var isZaigar = (href === null || href === void 0 ? void 0 : href.startsWith("https://exchange.zaigar.finance")) || (href === null || href === void 0 ? void 0 : href.startsWith("https://zaigar.finance")) || (href === null || href === void 0 ? void 0 : href.startsWith("https://zefi.zcore.network")) || (href === null || href === void 0 ? void 0 : href.startsWith("/")) || (href === null || href === void 0 ? void 0 : href.startsWith("https://swap.zcore.network"));
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
...
var SocialEntry2 = styled__default['default'].div(templateObject_4$2 || (templateObject_4$2 = __makeTemplateObject(["\n  display: block;\n  align-items: center;\n  justify-content: right;\n  height: ", "px;\n  padding: 0 26px;\n"], ["\n  display: block;\n  align-items: center;\n  justify-content: space-between;\n  height: ", "px;\n  padding: 0 26px;\n"])), MENU_ENTRY_HEIGHT);
var PanelFooter = function (_a) {
    ...
    return (React__default['default'].createElement(Container$4, null,
        React__default['default'].createElement(SocialEntry, null,
            cakePriceUsd ? (React__default['default'].createElement(PriceLink, { href: priceLinkZfai, target: "_blank" },
            ...
            React__default['default'].createElement(SocialEntry2, null,
                cakePriceUsd ? (React__default['default'].createElement(PriceLink, { href: priceLinkZaif, target: "_blank" },
                    React__default['default'].createElement(Icon$v2, { width: "24px", mr: "8px", ml: "8px" }),
                    React__default['default'].createElement(Text, { color: "textSubtle", bold: true }, "$" + zaifPriceUsd.toFixed(3)))) : (React__default['default'].createElement(Skeleton, { width: 80, height: 24 })),
...
var Menu = function (_a) {
    ...
    return (React__default['default'].createElement(Wrapper$1, null,
        ...
        React__default['default'].createElement(BodyWrapper, null,
            React__default['default'].createElement(Panel, { isPushed: isPushed, isMobile: isMobile, showMenu: showMenu, isDark: isDark, toggleTheme: toggleTheme, langs: langs, setLang: setLang, currentLang: currentLang, cakePriceUsd: cakePriceUsd,  zaifPriceUsd: zaifPriceUsd, pushNav: setIsPushed, links: links, priceLinkZfai: priceLinkZfai , priceLinkZaif: priceLinkZaif }),
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), {
    background: "#f1f0f0", backgroundDisabled: "#E9EAEB", contrast: "#0b2b27", invertedContrast: "#FFFFFF", input: "#ebf4ea", tertiary: "#EFF4F5", text: "#0e3731", textDisabled: "#BDC2C4", textSubtle: "#1e5951", borderColor: "#E9EAEB", card: "#FFFFFF", gradients: {
        bubblegum: "linear-gradient(139.73deg, #E6FDFF 0%, #F3EFFF 100%)",
    }
});
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), {
    secondary: "#0f5f54", background: "#343135", backgroundDisabled: "#28a392", contrast: "#FFFFFF", invertedContrast: "#0d4039", input: "#0098A1", primaryDark: "#0098A1", tertiary: "#28a392", text: "#FFFFFF", textDisabled: "#cccccc", textSubtle: "#c9c4d4", borderColor: "#28a392", card: "#27262c", gradients: {
...
exports.PancakeRoundIcon2 = Icon$v2;
